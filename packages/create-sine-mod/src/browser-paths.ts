...
import type { SupportedBrowser } from "./functions/browser/get-browser-id.js";
...
export async function findBrowserPath(
	...
	if (browser === "zen") {
		return await findZenPath(platformInfo);
	}
	throw new Error(`Unsupported browser: ${browser}`);
}

async function findZenPath(platformInfo: PlatformInfo): Promise<string | null> {
